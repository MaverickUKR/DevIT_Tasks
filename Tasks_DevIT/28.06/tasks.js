...
var PORT = 3000;
var DATA_DIR = path_1.default.join(__dirname, "data");
var findFile = function (dir, fileName) { return __awaiter(void 0, void 0, void 0, function () {
    var entries, i, entry, fullPath, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, findFile(fullPath, fileName)];
            case 3:
                result = _a.sent();
                if (result)
...
var server = http_1.default.createServer(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fileName = req.url === "/" ? "index.html" : req.url.slice(1);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, findFile(DATA_DIR, fileName)];
            case 2:
                filePath = _a.sent();
                if (!filePath) {
