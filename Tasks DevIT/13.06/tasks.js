...
// 5.
// const arr: [number, number, [number, number, [number, number]]] = [123, 233, [31, 40, [225, 6]]];
// function flatFilter(arr: Array<number>):  Array<number> {
//   const flattedArr: Array<number> = arr.flat(2);
//   const filteredArr: Array<number> = flattedArr.filter((e) => e > 100);
//   return filteredArr;
// }
// console.log(flatFilter(arr as any[]));
// _____________________________
// NUMBERS
// 1.
// let a: number = 4.33;
